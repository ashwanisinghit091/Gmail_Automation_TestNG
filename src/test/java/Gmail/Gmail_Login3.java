...
public class Gmail_Login3 extends Base{

	
	
	
	@Test
	public static void Gmaill3() throws IOException, AWTException, InterruptedException{
		
		
		Driver.findElement(By.xpath("//div[@class='z0']/div")).click();

		Driver.findElement(By.name("to")).sendKeys("");//put receiver mail id
		Driver.findElement(By.xpath("//input[@class='aoT']")).sendKeys("Automated Mail2");
		//Thread.sleep(4000);
